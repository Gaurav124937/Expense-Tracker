...
expenseForm.addEventListener("submit", function (event) {
  ...
  if (editingExpenseId == null) {
    ...
    infoDiv.innerHTML = `
    <p class="expense-text-styling expense-description ">${expenseTo.description}</p>
    <p class="expense-text-styling">₹${expenseTo.expense}</p>
    <p class="expense-text-styling">${expenseTo.category}</p>
  <p class="expense-text-styling">${expenseTo.date}</p>
  `;
