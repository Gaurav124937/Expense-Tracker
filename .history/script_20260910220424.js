...
function renderExpense(expense) {
  ...
  expenseElement.innerHTML = `
    <p class="expenseTextStyling">${expense.description}</p>
    <p class="expenseTextStyling">₹${expense.expense}</p>
    <p class="expenseTextStyling"> class="expenseTextStyling"${expense.category}</p>
  <p class="expenseTextStyling">${expense.date}</p>
