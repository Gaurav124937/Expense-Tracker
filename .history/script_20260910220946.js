...
function renderExpense(expense) {
  ...
  expenseElement.innerHTML = `
    <p class="expense-text">${expense.description}</p>
    <p class="expense-text">₹${expense.expense}</p>
    <p class="expense-text">${expense.category}</p>
  <p class="expense-text">${expense.date}</p>
